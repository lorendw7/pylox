...
The project is organized into **four tiers**, each a meaningful milestone. The final goal,
**Tier D**, is the leap from a tree-walking interpreter into a real **bytecode compiler +
virtual machine** — the same architecture used by CPython and the JVM.
...
| 1 | Lexer | Tokens, character scanning; the theory behind it — regular expressions ↔ finite automata (DFA/NFA) | `tokens.py`, `lexer.py` | ⏳ |
